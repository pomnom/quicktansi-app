@php
    $noBukuDisplay = ($kuitansi->no_buku && $kuitansi->no_buku !== 'null')
        ? $kuitansi->no_buku
        : ($kuitansi->periode_type . ($kuitansi->periode_number ? ' ' . $kuitansi->periode_number : '') . ' / ' . ($kuitansi->nomor_urut ? str_pad($kuitansi->nomor_urut, 3, '0', STR_PAD_LEFT) : str_repeat("\u{00A0}", 5)));
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="toolbar">
        <div class="toolbar-left">
            ...
            <div class="doc-info">
                ...
                <div class="doc-meta">No. Buku: {{ $noBukuDisplay }}</div>
            </div>
        </div>
    ...
    <div class="info-strip">
        <div class="info-chip">
            ...
            <span>No. Buku:&nbsp;<strong>{{ $noBukuDisplay }}</strong>
            </span>
        </div>
        <div class="info-chip">
        ...
        <div class="doc-header-right">
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="colon">:</td>
                    <td class="value">{{ $noBukuDisplay }}</td>
                </tr>
                <tr>
